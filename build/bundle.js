...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storeJs = __webpack_require__(3);

	var _storeJs2 = _interopRequireDefault(_storeJs);

	var _actionsJs = __webpack_require__(13);
	...
	var initProps = {
		...
		actions: _actionsJs2["default"]
	};

	var Home = __webpack_require__(209);
	var Detail = __webpack_require__(210);
	var NotFound = __webpack_require__(211);
	...
	var App = _react2["default"].createClass({
		...
		componentDidMount: function componentDidMount() {
			...
			this.props.store.listen(function (data) {
				_this.setState({ "temp": data.toJSON() });
			});
		},
		render: function render() {
			return _react2["default"].createElement(
				"div",
				{ style: { "height": "100%" } },
				_react2["default"].createElement(RouteHandler, _extends({}, this.state.temp, { actions: this.props.actions })),
				"}"
			);
		}
	});
	var routes = _react2["default"].createElement(
		Route,
		{ path: "/", handler: App },
		_react2["default"].createElement(Route, { name: "home", path: "home", handler: Home }),
		_react2["default"].createElement(
			Route,
			{ name: "detail", path: "detail", handler: Detail },
			_react2["default"].createElement(Route, { path: ":name", handler: Detail }),
			_react2["default"].createElement(NotFoundRoute, { handler: Detail })
		),
	...
	_reactRouter2["default"].run(routes, _reactRouter2["default"].HistoryLocation, function (Root) {
		_react2["default"].render(_react2["default"].createElement(Root, initProps), document.body);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fynx = __webpack_require__(4);

	var _immutable = __webpack_require__(9);

	var Store = (0, _fynx.createCursorStore)((0, _immutable.fromJS)({ "count": 0, "array": [1, 2, 3] }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _axn = __webpack_require__(5);
	...
	var _createRawStore2 = __webpack_require__(7);
	...
	var _createImmutableStore2 = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createRawStore = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _immutableContribCursor = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Actions = (0, _fynx.createActions)(["add", "minus"]);

	Actions.add.listen(function () {
		(0, _store2["default"])().set("count", (0, _store2["default"])().get("count") + 1);
	});

	Actions.minus.listen(function () {
		(0, _store2["default"])().set("count", (0, _store2["default"])().get("count") - 1);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.DefaultRoute = __webpack_require__(171);
	...
	exports.HistoryLocation = __webpack_require__(190);
	exports.RefreshLocation = __webpack_require__(191);
	exports.StaticLocation = __webpack_require__(192);
	exports.TestLocation = __webpack_require__(193);

	exports.ImitateBrowserBehavior = __webpack_require__(194);
	exports.ScrollToTopBehavior = __webpack_require__(195);

	exports.History = __webpack_require__(189);
	exports.Navigation = __webpack_require__(196);
	exports.State = __webpack_require__(197);
	...
	exports.createRoutesFromReactChildren = __webpack_require__(198);

	exports.create = __webpack_require__(199);
	exports.run = __webpack_require__(208);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PropTypes = __webpack_require__(172);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assign = __webpack_require__(26);
	var warning = __webpack_require__(28);
	var DefaultRoute = __webpack_require__(171);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var canUseDOM = __webpack_require__(64).canUseDOM;
	var LocationActions = __webpack_require__(188);
	var ImitateBrowserBehavior = __webpack_require__(194);
	var HashLocation = __webpack_require__(187);
	var HistoryLocation = __webpack_require__(190);
	var RefreshLocation = __webpack_require__(191);
	var StaticLocation = __webpack_require__(192);
	var ScrollHistory = __webpack_require__(200);
	var createRoutesFromReactChildren = __webpack_require__(198);
	var isReactChildren = __webpack_require__(202);
	var Transition = __webpack_require__(203);
	var PropTypes = __webpack_require__(172);
	var Redirect = __webpack_require__(205);
	var History = __webpack_require__(189);
	var Cancellation = __webpack_require__(204);
	var Match = __webpack_require__(206);
	var Route = __webpack_require__(173);
	var supportsHistory = __webpack_require__(207);
	var PathUtils = __webpack_require__(174);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var invariant = __webpack_require__(20);
	var canUseDOM = __webpack_require__(64).canUseDOM;
	var getWindowScrollPosition = __webpack_require__(201);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createRouter = __webpack_require__(199);
